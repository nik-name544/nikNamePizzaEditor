  ...
  return (
    <div className="order-list">
      <header className="payment-form__header">
        <Link
          to="/pizza-editor-login"
          className="payment-form__header-link"
        ></Link>
        ...
        <div className="container">
          <div className="order-list__item">
            <div className="order-list__item-top delivered">
              ...
              <p className="order-list__item-state">
                21 октября 2020, 13:40 • Доставлен
              </p>
            </div>
            <div className="order-list__item-mid">
              <p className="order-list__item-title">Ленивая Маргарита</p>
              <div className="order-list__item-text">{pizzaItem}</div>
            </div>
          ...
          <div className="order-list__item">
            ...
            <div className="order-list__item-bot">
              ...
              <p className="order-list__item-bot-state ">Повторить заказ</p>
            </div>
          </div>
