  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <fieldset>
        ...
        <label>
          <input ref={register} type="radio" value="thin" name="dough" />
          {PizzaServData.dough.thin.name}
        </label>
        <label>
          <input ref={register} type="radio" value="fluffy" name="dough" />
      ...
      <fieldset>
        ...
        <label>
          <input ref={register} type="radio" value="small" name="size" />
          {PizzaServData.size.small.name}
        </label>
        <label>
          <input ref={register} type="radio" value="big" name="size" />
      ...
      <fieldset>
        ...
        <label>
          <input ref={register} type="radio" value="tomatoSauce" name="sauce" />
          {PizzaServData.sauce.tomatoSauce.name}
        </label>
        <label>
          <input ref={register} type="radio" value="whiteSauce" name="sauce" />
          {PizzaServData.sauce.whiteSauce.name}
        </label>
        <label>
          <input ref={register} type="radio" value="spicySauce" name="sauce" />
      ...
      <fieldset>
        ...
        <label>
          <input ref={register} type="checkbox" value="cheddar" name="cheese" />
          {PizzaServData.cheese.cheddar.name}
        </label>
        <label>
          <input ref={register} type="checkbox" value="dorBlue" name="cheese" />
      ...
      <fieldset>
        ...
        <label>
          <input ref={register} type="checkbox" value="bacon" name="meat" />
          {PizzaServData.meat.bacon.name}
        </label>
        <label>
          <input ref={register} type="checkbox" value="pepperoni" name="meat" />
